...
<body>
	...
	<!-- Card que contiene form de crear contacto, el que debe enviar la informacion hacia la base de datos para ejecutar un metodo create -->
				...
				<div class="card-body ">
					...
					<form action="ContactoServlet" method="post">
						...
						<div class="col-sm-10 mx-auto text-center">
							<button type="submit" class="btn btn-primary col-sm-5">Enviar</button>
