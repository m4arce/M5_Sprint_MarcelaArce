...
<body>
	...
	<!-- Card que contiene form de crear usuario, el que debe enviar la informacion hacia la base de datos para ejecutar un metodo create -->
		...
		<div class="col">
			<div class="card h-100 bg-secondary mx-auto" style="width: 400px;">
				<div class="card-body ">
					...
					<form action="ListadoUsuariosServlet" method="post">					
