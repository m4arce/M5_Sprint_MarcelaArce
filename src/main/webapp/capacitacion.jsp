...
<body>
	<div class="position-relative">
		<h1 class="text-center">CREAR CAPACITACION</h1>
	</div>
	<br>
	<br>

	<!-- Card que contiene form de crear capacitacion, el que debe enviar la informacion hacia la base de datos para ejecutar un metodo create -->
	<div class="row row-cols-1 row-cols-md-1">
		<div class="col">
			<div class="card h-100 bg-secondary mx-auto" style="width: 400px;">
				<div class="card-body ">
					<h5 class="card-title text-center">CREAR CAPACITACION</h5>
					<form action="ListarCapacitacionesServlet" method="post">
						<div class="row mb-3">
						...
						<div class="row mb-3">
							<div class="col-sm-10 mx-auto">
								<input type="text" class="form-control" name="nombreDocente"
									placeholder="Nombre Docente" required>
							</div>
						</div>
						...
						<div class="row mb-3">
							<div class="col-sm-10 mx-auto">
								<input type="text" class="form-control" name="fechaTermino"
									placeholder="Fecha Termino" required>
							</div>
						</div>
						...
						<div class="row mb-3">
							<div class="col-sm-10 mx-auto">
								<input type="text" class="form-control" name="precio"
									placeholder="Valor Curso" required>
							</div>
						</div>

						<div class="col-sm-10 mx-auto text-center">
							<button type="submit" class="btn btn-primary col-sm-5">Crear</button>
